...
Explanation: Since your score is 0 initially, you cannot play the token face-down. You also cannot play it face-up 
since your power (50) is less than tokens[0] (100).
...
input_power = 50
expected_output = 0
output = Solution().bagOfTokensScore(input_tokens, input_power)
print(f"Test Case 1 - Expected: {expected_output}, Result: {output}")
...
"""
Runtime 54ms
Beats 53.66% of users with Python3
